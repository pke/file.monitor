...
public interface User32 extends W32API {
	...
	/** ASCII version. */
	int GetWindowModuleFileName(HWND hWnd, byte[] lpszFileName,
			int cchFileNameMax);
	...
	int PostMessage(HWND hWnd, int msg, WPARAM wParam, LPARAM lParam);

	int PostMessage(HWND hWnd, int msg, int wParam, LPARAM lParam);

	int PostMessage(HWND hWnd, int msg, int wParam, int lParam);

	<T> int PostMessage(HWND hWnd, int msg, WPARAM wParam, T lParam);
	...
	boolean SetWindowText(HWND window, String text);
}
